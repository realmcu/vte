...
printf("***** for a ****************************\n");
    ...
    retdatabinchk('a', buffer, size, 0, &errmsg);
 ...
 printf("\tFAIL return value %d, expected -1\n", ret);
    ...
    offset232400;
    retdatabinchk('a', &buffer[1], size-1, offset, &errmsg);
 ...
 printf("\tFAIL return value %d, expected -1\n", ret);
    ...
    retdatabinchk('a', &buffer[1], size-1, offset+1, &errmsg);
    printf("databinchk('a', &buffer[1], %d, %d, &errmsg) returned %d: %s\n",
...
printf("***** for c ****************************\n");
    ...
    retdatabinchk('c', buffer, size, 0, &errmsg);
 ...
 printf("\tFAIL return value %d, expected -1\n", ret);
    ...
    offset232400;
    retdatabinchk('c', &buffer[1], size-1, offset, &errmsg);
 ...
 printf("\tFAIL return value %d, expected -1\n", ret);
    ...
    retdatabinchk('c', &buffer[1], size-1, offset+1, &errmsg);
    printf("databinchk('c', &buffer[1], %d, %d, &errmsg) returned %d: %s\n",
 size-1, offset+1, ret, errmsg);
    if ( ret  number )
 printf("\tPASS return value of %d as expected\n", number);
...
printf("***** for C ****************************\n");
 ...
 printf("\tFAIL return value %d, expected -1\n", ret);
    ...
    offset18;
    retdatabinchk('C', &buffer[18], size-18, 18, &errmsg);
