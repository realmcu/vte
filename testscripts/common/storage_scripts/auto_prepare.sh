...
insmod_SD()
{
    ...
    find=`find /lib/ -name mmc_core.ko | wc -l`;
    lsmod | grep mmc_core;
    ...
    find=`find /lib/ -name mmc_block.ko | wc -l`;
    ...
    find=`find /lib/ -name mx_sdhci.ko | wc -l`;
    lsmod | grep mx_sdhci
    if [ $? -ne 0 ] && [ $find -eq 1 ]; then
       modprobe mx_sdhci;
        sleep 2;
...
insmod_ATA()
{
    ...
    if [ $platform = "MX31" ] || [ $platform = "MX32" ]; then
        find=`find /lib/ -name ide-core.ko | wc -l`;
        lsmod | grep ide-core;
        if [ $? -ne 0 ] && [ $find -eq 1 ]; then
           modprobe ide-core;
            sleep 2;
        ...
        find=`find /lib/ -name ide-disk.ko | wc -l`;
        lsmod | grep ide-disk;
        if [ $? -ne 0 ] && [ $find -eq 1 ]; then
           modprobe ide-disk;
            sleep 2;
        ...
        find=`find /lib/ -name ide-generic.ko | wc -l`;
        ...
        find=`find /lib/ -name mxc_ide.ko | wc -l`;
        lsmod | grep mxc_ide;
        if [ $? -ne 0 ] && [ $find -eq 1 ]; then
           modprobe mxc_ide;
            sleep 2;
    ...
    if [ $platform = "MX35" ] || [ $platform = "MX37" ] || [ $platform = "MX51" ]; then
        find=`find /lib/ -name pata_fsl.ko | wc -l`;
        lsmod | grep pata_fsl;
        if [ $? -ne 0 ]; then
            if [ $find -eq 1 ]; then
               modprobe pata_fsl;
...
insmod_V4L()
{
    ...
    find=`find /lib/ -name ipu_prp_vf_sdc.ko | wc -l`;
    ...
    find=`find /lib/ -name ipu_prp_vf_sdc_bg.ko | wc -l`;
    ...
    find=`find /lib/ -name ipu_still.ko | wc -l`;
    ...
    find=`find /lib/ -name ov2640_camera.ko | wc -l`;
    ...
    find=`find /lib/ -name mxc_v4l2_capture.ko | wc -l`;
...
insmod_BT()
{
    ...
    find=`find /lib/ -name mxc_bt.ko | wc -l`;
    lsmod | grep mxc_bt;
    if [ $? -ne 0 ] && [ $find -eq 1 ]; then
       modprobe mxc_bt;
        sleep 2;
...
insmod_USBH()
{
    ...
    find=`find /lib/ -name ehci-hcd.ko | wc -l`;
    lsmod | grep ehci*;
    if [ $? -ne 0 ]; then
          if [ $find -eq 1 ]; then
           modprobe ehci-hcd;
