...
/* Global Variables */
char *TCID      "opl_rotate_testapp";  /* test program identifier.              */
int  TST_TOTAL  1;                     /* total number of tests in this file.   */

int Idflag  0, Dflag  0; Caseflag  0, Iterflag  0, Writflag  0, Sflag0;    /* binary flags: opt or not */
...
int main(int argc, char **argv)
{
 ...
 tst_brkm(TBROK, cleanup, "OPTION PARSING ERROR - %s", err_msg);
    ...
    VT_rv  VT_opl_rotate_test(Id, Case, Iter, Writ, r_flag, R_flag);       /*with the parameters needed come from parse_opt())*/
