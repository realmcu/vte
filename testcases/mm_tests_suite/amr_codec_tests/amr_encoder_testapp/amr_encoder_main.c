...
/* Global Variables */
char *TCID      "amr_encoder_testapp"; /* test program identifier.          */
...
int main(int argc, char **argv)
{
 int VT_rv  TFAIL;
 char *msg;
 int Id  EXHAUSTIVE_ENCODE;
 int Case  USING_THREAD;
 int Iter  ITERATIONS;

/* parse options. */
 if ( (msgparse_opts(argc, argv, options, help)) ! NULL ){
...
/* VTE : print results and exit test scenario */
 VT_rv  VT_amr_encoder_test(Id, Case, Iter); /*with the parameters needed come from parse_opt())*/
