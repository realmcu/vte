...
#include "Wizard_dialog_test_X.h"
...
/* Global Variables */
char *TCID     = "Wizard_dialog_TEST_X"; /* test program identifier.          */
...
void cleanup()
{
    /* VTE : Actions needed to get a stable target environment */
		...
		VT_rv = VT_Wizard_dialog_cleanup();
		if (VT_rv != TPASS)
		{
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_Wizard_dialog_test_X(argc,argv); /*with the parameters needed come from parse_opt())*/
