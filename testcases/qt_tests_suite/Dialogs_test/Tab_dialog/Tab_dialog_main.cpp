...
/* Global Variables */
char *TCID     = "Tab_dialog_TEST_X"; /* test program identifier.          */
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_Tab_dialog_test_X(argc,argv); /*with the parameters needed come from parse_opt())*/
