...
/* Global Variables */
char *TCID     = "Table_TEST_X"; /* test program identifier.          */
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_Table_test_X(argc,argv); /*with the parameters needed come from parse_opt())*/
