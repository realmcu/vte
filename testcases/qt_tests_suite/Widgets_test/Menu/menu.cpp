/****************************************************************************
** $Id: menu.cpp,v 1.1.1.1 2008/04/14 09:01:46 b06080 Exp $
**
...
{  
	...
	label->setText( "A context menu is available.\n"
					"Invoke it by right-clicking." );
	label->setGeometry( 0, height() + 60, width(), 60 );
