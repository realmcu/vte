/****************************************************************************
** $Id: textedit.cpp,v 1.1.1.1 2008/04/14 09:01:40 b06080 Exp $
**
...
void TextEdit::setupFileActions()
{
    ...
    a->addTo( menu );
    a = new QAction( tr( "E&xit fail" ), 0, this, "fileExit" );
    connect( a, SIGNAL( activated() ), this, SLOT( fileExit() ) );
    a->addTo( menu );
/*
    a = new QAction( tr( "E&xit fail" ), 0, this, "fileExit" );
    connect( a, SIGNAL( activated() ), this, SLOT( exitFail() ) );
    a->addTo( menu );
*/
    a = new QAction( tr( "&Quit pass" ), 0, this, "fileQuit" );
    connect( a, SIGNAL( activated() ), this, SLOT( exitPass()) );
    a->addTo( menu );
