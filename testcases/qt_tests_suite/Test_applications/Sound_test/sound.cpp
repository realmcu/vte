/****************************************************************************
** $Id: sound.cpp,v 1.1.1.1 2008/04/14 09:01:40 b06080 Exp $
**
    ...
    bucket4("sounds/4.wav")
{
    ...
    file->insertSeparator();
    file->insertItem("E&xit pass",  this, SLOT(exitPass()));
    file->insertItem("Q&uit fail",  this, SLOT(exitFail()));
