...
/* Global Variables */
char *TCID     = "Draw_figures_TEST_X"; /* test program identifier.          */
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_Draw_figures_test_X(argc,argv); /*with the parameters needed come from parse_opt())*/
