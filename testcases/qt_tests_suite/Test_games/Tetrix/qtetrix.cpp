/****************************************************************************
** $Id: qtetrix.cpp,v 1.1.1.1 2008/04/14 09:01:44 b06080 Exp $
**
...
#define ADD_LABEL( str, x, y, w, h )			\
    ...
    connect( quitButton , SIGNAL(clicked()), SLOT(exitPass()));
    connect( exitButton , SIGNAL(clicked()), SLOT(exitFail()));
    ...
    quitButton->setGeometry( 330, 265, 90, 30 );
    exitButton->setGeometry( 430, 265, 90, 30 );
    pauseButton->setGeometry( 330, 310, 90, 30 );
