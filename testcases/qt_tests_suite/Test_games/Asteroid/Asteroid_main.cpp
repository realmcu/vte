...
/* Global Variables */
char *TCID     = "Asteroid_TEST_X"; /* test program identifier.          */
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_Asteroid_test_X(argc,argv); /*with the parameters needed come from parse_opt())*/
