...
Test Name:   TO BE COMPLETED  ETHERNET_TEST1
...
#include "Transformations_test_X.h"
...
/* Global Variables */
char *TCID     = "Transformations_TEST_X"; /* test program identifier.          */
...
void cleanup()
{
    /* VTE : Actions needed to get a stable target environment */
		...
		VT_rv = VT_Transformations_cleanup();
		if (VT_rv != TPASS)
		{
...
void setup()
{
   ...
   /* Capture signals. */
    ...
    /* VTE : Actions needed to prepare the test running */
		VT_rv = VT_Transformations_setup();
		if (VT_rv != TPASS)
		{
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_Transformations_test_X(argc,argv); /*with the parameters needed come from parse_opt())*/
