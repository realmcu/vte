...
static void tc01(void)
{
 ...
 printk(KERN_INFO "Test Case 1: register_blkdev() with auto allocating major numbers (major0)\n");
...
static void tc02(void)
{
 ...
 printk(KERN_INFO "Test Case 2: stress test of register_blkdev() with auto allocating major numbers (major0)\n");

 memset(major, 0, sizeof(major));

 for (i0; i<sizeof(major)/sizeof(*major); i++) {
...
static void tc03(void)
{
 ...
 printk(KERN_INFO "Test Case 3: register_blkdev() with major256\n");
...
static void tc07(void)
{
 ...
 printk(KERN_INFO "Test Case 7: register_blkdev() with nameNULL\n");
...
static void tc10(void) {
 ...
 printk(KERN_INFO "Test Case 10: unregister_blkdev() with major0\n");
 ...
 if (0 < major) {
  printk(KERN_DEBUG "calling unregister_blkdev() with major0\n");
