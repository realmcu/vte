...
int main(int ac, char **av)
{
 ...
 char* cmdstringNULL;  /* hold command string to execute using system() */
 ...
 if (system(cmdstring)  0) {
  ...
  usedfds3;   /* Could not get processes used fds, so assume 3 */
 unlink("pipe07.tmp");
