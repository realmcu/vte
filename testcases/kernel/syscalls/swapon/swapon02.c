...
setup01()
{
        ...
        if ((strncmp(kmachine, "ia64", 4))  0) {
                if(system("dd if/dev/zero ofswapfile01 bs1024  count65536 > tmpfile"
                                        " 2>&1") ! 0) {
                        tst_brkm(TBROK, cleanup, "Failed to create file for swap");
                }
        } else if (pagesize  65536)
        {
                if(system("dd if/dev/zero ofswapfile01 bs1048  count655 > tmpfile"
                                        " 2>&1") ! 0) {
                        tst_brkm(TBROK, cleanup, "Failed to create file for swap");
                }
        }else {
                if(system("dd if/dev/zero ofswapfile01 bs1048  count40 > tmpfile"
                                        " 2>&1") ! 0) {
                        tst_brkm(TBROK, cleanup, "Failed to create file for swap");
                }
        }
...
setup03()
{
        ...
        /*create file*/
        if ((strncmp(kmachine, "ia64", 4))  0) {
                if(system("dd if/dev/zero ofalreadyused bs1024  count65536 > tmpfile"
                                        " 2>&1") ! 0) {
                        tst_brkm(TBROK, cleanup, "Failed to create file for swap");
                }
        } else if (pagesize  65536)
        {
                if(system("dd if/dev/zero ofalreadyused bs1048  count655 > tmpfile"
                                        " 2>&1") ! 0) {
                        tst_brkm(TBROK, cleanup, "Failed to create file for swap");
                }
        }else {
                if(system("dd if/dev/zero ofalreadyused bs1048  count40 > tmpfile"
                                        " 2>&1") ! 0) {
                        tst_brkm(TBROK, cleanup, "Failed to create file for swap");
                }
        }
