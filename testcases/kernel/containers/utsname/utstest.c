 ...
 * test2:
 P1: sethostname(A);
 P2: (wait); Bgethostname
 Ensure (AB)

 * test3:
 P1: Agethostname; unshare(utsname); sethostname(newname); Cgethostname
 P2: Bgethostname; (wait); (wait); Dgethostname
 Ensure (AB && AD && C!D)

 * test4:
 P1: Agethostname; unshare(utsname); (wait); Cgethostname
 P2: Bgethostname; (wait); sethostname(newname); Dgethostname
 Ensure (AB && AC && C!D)

 * test5:
 P1: drop_privs(); unshare(utsname); (wait); Cgethostname
 P2: (wait); sethostname(B); Dgethostname
 Ensure (BCD) and state is ok.
 *
 */
