  ...
  if (fd  -1 || off ! (TMP_FILELEN-DUMMY_STRLEN) || rc  -1) {
   ...
   if (rc  0) {
    ...
    if (nelem  2) {
     ...
     DMLOG_PRINT(DMLVL_DEBUG, "  nelem  %d\n", nelem);
     LogExtents(Extents, nelem);
     if ((i1) && (Extents[0].ex_length + Extents[1].ex_length  TMP_FILELEN) &&
         (i2) && (Extents[0].ex_offset  0) &&
         (i3) && (Extents[0].ex_length  Extents[1].ex_offset) &&
         (i4) && (Extents[0].ex_type  DM_EXTENT_HOLE) &&
         (i5) && (Extents[1].ex_type  DM_EXTENT_RES)
        ) {
      DMLOG_PRINT(DMLVL_DEBUG, "%s extent information correct\n", szFuncName);
      DMVAR_PASS();
     } else {
  ...
  if (fd  -1 || off ! (TMP_FILELEN-DUMMY_STRLEN) || rc  -1) {
   ...
   if (rc  0) {
    ...
    if (nelem  2) {
     ...
     DMLOG_PRINT(DMLVL_DEBUG, "  nelem  %d\n", nelem);
     LogExtents(Extents, nelem);
     if ((i1) && (Extents[0].ex_length + Extents[1].ex_length  ((TMP_FILELEN/2)&(~(BLK_SIZE-1)))) &&
         (i2) && (Extents[0].ex_offset  0) &&
         (i3) && (Extents[0].ex_length  Extents[1].ex_offset) &&
         (i4) && (Extents[0].ex_type  DM_EXTENT_RES) &&
         (i5) && (Extents[1].ex_type  DM_EXTENT_HOLE)
        ) {
      DMLOG_PRINT(DMLVL_DEBUG, "%s extent information correct\n", szFuncName);
      DMVAR_PASS();
     } else {
  ...
  if (fd  -1 || off ! (TMP_FILELEN-DUMMY_STRLEN) || rc  -1) {
   ...
   if (rc  0) {
    ...
    if (nelem  3) {
     DMLOG_PRINT(DMLVL_DEBUG, "  nelem  %d\n", nelem);
     LogExtents(Extents, nelem);
     if ((i1) && (Extents[0].ex_length + Extents[1].ex_length + Extents[2].ex_length  TMP_FILELEN) &&
         (i2) && (Extents[0].ex_offset  0) &&
         (i3) && (Extents[0].ex_length  Extents[1].ex_offset) &&
         (i4) && (Extents[1].ex_length + Extents[1].ex_offset  Extents[2].ex_offset) &&
         (i5) && (Extents[0].ex_type  DM_EXTENT_RES) &&
         (i6) && (Extents[1].ex_type  DM_EXTENT_HOLE) &&
         (i7) && (Extents[2].ex_type  DM_EXTENT_RES)
        ) {
      DMLOG_PRINT(DMLVL_DEBUG, "%s extent information correct\n", szFuncName);
      DMVAR_PASS();
     } else {
  ...
  if (fd  -1 || off ! TMP_FILELEN-DUMMY_STRLEN || rc  -1) {
   ...
   if (rc  1) {
    ...
    if (nelem  NUM_EXTENTS) {
     DMLOG_PRINT(DMLVL_DEBUG, "  nelem  %d\n", nelem);
     LogExtents(Extents, nelem);
     if ((i1) && (Extents[0].ex_offset  0) &&
         (i2) && (Extents[0].ex_length  Extents[1].ex_offset) &&
         (i3) && (Extents[1].ex_length + Extents[1].ex_offset  Extents[2].ex_offset) &&
         (i4) && (Extents[2].ex_length + Extents[2].ex_offset  Extents[3].ex_offset) &&
         (i5) && (Extents[3].ex_length + Extents[3].ex_offset  Extents[4].ex_offset) &&
         (i6) && (Extents[4].ex_length + Extents[4].ex_offset  Extents[5].ex_offset) &&
         (i7) && (Extents[5].ex_length + Extents[5].ex_offset  Extents[6].ex_offset) &&
         (i8) && (Extents[6].ex_length + Extents[6].ex_offset  Extents[7].ex_offset) &&
         (i9) && (Extents[7].ex_length + Extents[7].ex_offset  off) &&
         (i10) && (Extents[0].ex_type  DM_EXTENT_RES) &&
         (i11) && (Extents[1].ex_type  DM_EXTENT_HOLE) &&
         (i12) && (Extents[2].ex_type  DM_EXTENT_RES) &&
         (i13) && (Extents[3].ex_type  DM_EXTENT_HOLE) &&
         (i14) && (Extents[4].ex_type  DM_EXTENT_RES) &&
         (i15) && (Extents[5].ex_type  DM_EXTENT_HOLE) &&
         (i16) && (Extents[6].ex_type  DM_EXTENT_RES) &&
         (i17) && (Extents[7].ex_type  DM_EXTENT_HOLE)
        ) {
      DMLOG_PRINT(DMLVL_DEBUG, "%s extent information correct\n", szFuncName);
