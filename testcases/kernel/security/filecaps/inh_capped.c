...
int main()
{
 ...
 ret  set_caps_from_text("alliep cap_sys_admin-iep");
 ...
 ret  set_caps_from_text("alleip cap_sys_admin-ep+i");
 ...
 ret  set_caps_from_text("allip cap_setpcap-e+ip cap_sys_admin+i-ep");
 ...
 ret  set_caps_from_text("alliep cap_sys_admin-iep cap_setpcap-e+ip");
 ...
 ret  set_caps_from_text("alliep cap_sys_admin-ep+i cap_setpcap-e+ip");
