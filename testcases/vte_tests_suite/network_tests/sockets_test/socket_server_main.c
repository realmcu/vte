...
/*================================================================================================*/
/**
    @file   socket_server_main.c

    @brief   Network socket_server test main function.
====================================================================================================
Revision History:
...
Test Executable Name:  socket_server

Test Strategy:  A test for send and recive message by use UDP/TCP sockets
=================================================================================================*/
...
/* Global Variables */
char *TCID     = "TGE-LV-CS-0010"; /* test program identifier.          */
...
void cleanup()
{
	...
	VT_rv = VT_socket_server_test_cleanup();
	if (VT_rv != TPASS)
	{
...
void setup()
{
	...
	VT_rv = VT_socket_server_test_setup();
	if (VT_rv != TPASS)
	{
...
int main(int argc, char **argv)
{
    ...
    VT_rv = VT_socket_server_test(argc,argv);
