/*====================*/
/**
    @file   socket_client_main.c

    @brief   Network socket_client test main function.
*/
/*======================
...
Test Executable Name:  socket_client
...
void cleanup()
{
 ...
 VT_rv = VT_socket_client_test_cleanup();
 if (VT_rv != TPASS)
 {
...
void setup()
{
 ...
 VT_rv = VT_socket_client_test_setup();
 if (VT_rv != TPASS)
 {
...
int main(int argc, char **argv)
{
 int VT_rv = TFAIL;
    ...
    VT_rv = VT_socket_client_test(argc,argv);
