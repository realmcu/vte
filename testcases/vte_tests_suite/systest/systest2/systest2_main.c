...
void Help( void )
{
        ...
        printf("         0 - AP+BP communication over SDMA;\n");
        printf("         1 - FS transfers to from SD(MMC);\n");
        printf("-M <dirname> FFS mounting point. Default value is ./output \n");
        printf("-F <devname> FFS device name to be mounted: SD/MMC card. Default value is /dev/mmcblk0p1 (MMC card)\n");
}
