...
void Help( void )
{
        ...
        printf("-O <devname> V4L output device name. Default value is /dev/video16 \n");
...
int main( int argc, char ** argv )
{
        ...
        // V4L output device name.
        int v4lDevOFlag = 0; char * v4lDevOOpt = 0;
        ...
        option_t options[] =
        {
                ...
                { "O:",  &v4lDevOFlag,              &v4lDevOOpt}, // v4l device name
        ...
        if (v4lDevOFlag)
        {
                ...
                strncpy(gTestappConfig.mV4LDevOName, v4lDevOOpt, MAX_STR_LEN);
        }
        else
        {
                // Set to default.
                strncpy(gTestappConfig.mV4LDevOName, "/dev/video16", MAX_STR_LEN);
        }
        ...
        gTestappConfig.mEncryptOnly = 0;
        gTestappConfig.mInjectCRCError = 1;
