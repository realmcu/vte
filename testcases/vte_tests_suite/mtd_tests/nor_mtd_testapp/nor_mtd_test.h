...
==================================================================================================*/
#ifndef NOR_MTD_TEST_H
#define NOR_MTD_TEST_H
...
#define NOR_MTD_DEVICE        "/dev/mtd/2"
...
int VT_nor_mtd_test_erlck(void);
int VT_nor_mtd_test_wrner(void);
int VT_nor_mtd_test_wrlck(void);
