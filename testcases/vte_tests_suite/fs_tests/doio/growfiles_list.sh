...
# Spring                     12/12/2008       n/a      Enhance error detect
#############################################################################
# Portability:  ARM sh bash 
#
# File Name:    growfiles_list.sh
# Total Tests:       30 
...
cleanup()
{
    tst_resm TFAIL "growfile failed at case $last_err_no"
    exit $last_err_no
}
