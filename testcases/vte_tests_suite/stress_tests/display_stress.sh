...
/unit_tests/mxc_vpu_test.out -D "-f 0 -i ${b_stream_path} -o /dev/fb2" &
...
a_stream_path=/mnt/nfs/test_stream/power_stream/video/Mpeg4_SP3_1920x1080_23.97fps_9760kbps_AACLC_44KHz_2ch_track1_track1.cmp
