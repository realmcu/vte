...
do
	...
	do
		...
		do
			...
			epdc_REAGL -T $i -R $j -S 0 -s 0:0:128:128,257,1,0,$k,0,0,0:0:0:0 || RC=$(expr $RC + 1)
			epdc_REAGL -T $i -R $j -S 1 -s 0:0:128:128,257,1,0,$k,0,0,0:0:0:0 || RC=$(expr $RC + 1)
			epdc_REAGL -T $i -R $j -S 2 -s 0:0:128:128,257,1,0,$k,0,0,0:0:0:0 || RC=$(expr $RC + 1)
			done
		done
	done
