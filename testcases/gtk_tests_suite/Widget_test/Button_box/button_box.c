...
gint  horizontal;
  ...
  str=gtk_widget_get_name(GTK_WIDGET(po));
...
GtkWidget *box_p;
  gtk_init (&argc, &argv);
    ...
    box3=gtk_vbox_new(homogen,space);
    box4=gtk_vbox_new(homogen,space);
    box2_2=gtk_hbox_new(FALSE,5);
    box2_3=gtk_hbox_new(FALSE,0);
