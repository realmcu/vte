...
main(int argc, char **argv)
{
 ...
 if (fdisable) {
    ...
    wdt.TimerUse  1;    /* 1FRB2 2POST 3OSLoad 4SMS_OS 5OEM */
    wdt.TimerAction  0; /* 0none 1reset 2powerdown 3powercycle */
    wdt.PretimerInterrupt  0; /* 0none 1SMI 2NMI 3message */
    ...
    /* use t for timeout */
    /* TODO: add setting wdt values here */
    wdt.TimerUse  4;    /* 1FRB2 2POST 3OSLoad 4SMS_OS 5OEM */
    wdt.TimerAction  1; /* 0none 1reset 2powerdown 3powercycle */
    wdt.PretimerInterrupt  2; /* 0none 1SMI 2NMI 3message */
