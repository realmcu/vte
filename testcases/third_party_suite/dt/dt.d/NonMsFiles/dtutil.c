 ...
 *
 * December 20th, 2004 by Robin T. Miller.
 *      Added FmtKeepAlive() to format messages for keepalive alarm.
 *
 * December 19th, 2004 by Robin T. Miller
...

/*
 * Functions to display ASCII time.
 */
char *
 ...
 *	%p = The pass count.
 *	%P = The pass limit.
 *      %r = The records read or written.
 *      %R = The total records read and written.
          ...
          switch (*(from + 1)) {
            ...
            case 'r': {
              if (raw_flag) {
                ...
                /* Note: Partial records read/written not tracked. */
