...
char **argv;
{
	...
	// modify by Victor Cui, acording to https://bugs.launchpad.net/ubuntu/+source/iozone3/+bug/320615
	// a ubuntu bug when "make linux" and execute the binary
	//gethostname(controlling_host_name,256);
	gethostname(controlling_host_name,sizeof(controlling_host_name));
